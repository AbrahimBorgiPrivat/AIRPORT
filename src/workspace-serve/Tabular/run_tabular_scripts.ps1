...
$modelPath = ".\src\workspace-serve\SemanticModel\Airport Passenger Flight Insights (Power BI Demo).SemanticModel\definition\model.tmdl"
...
$scripts = @(
    ...
    # CALCULATED TABLES
    "$scriptsBase\Tables\CalculatedTable\_CUSTOMTABLE - NUMBERS.csx"
)
